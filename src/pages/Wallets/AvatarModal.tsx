...
const AvatarModal: React.FC<AvatarModalProps> = ({ opened, onClose, userName, avatarSrc }) => {
  return (
    <Modal
      opened={opened}
      onClose={onClose} // Закрыть модальное окно
      title={<Text size="lg" >Individual Accaunt</Text>} >
      <div className="flex flex-col items-center">
        ...
        <Button variant="subtle" color="black" radius="lg" fullWidth className="mt-5">Create Entiti Account</Button>
